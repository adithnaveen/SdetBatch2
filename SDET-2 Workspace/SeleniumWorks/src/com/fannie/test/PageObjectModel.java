...
import com.fannie.pom.SearchPage;
...
public class PageObjectModel {
	...
	public void test() {
		driver.get(baseUrl);
		SearchPage.clickFlightsTab(driver).click();
		;
		SearchPage.fillOriginTextBox(driver, "New York");
		SearchPage.destinationTextBox(driver).sendKeys("Chicago");
		SearchPage.departureDateTextBox(driver).sendKeys("12/25/2016");
		...
		SearchPage.returnDateTextBox(driver).sendKeys("12/31/2016");
